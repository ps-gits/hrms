      ...
      columnDefs: [
...

        {
          ...
          render: function (data, type, full, meta) {
            ...
            //return '<div> <span class="user-code">' + $plan + 'Included Users:</span><br><span class="user-code">' + $includedUsers  + $duration + ' Days</span></div>';
            return (
              '<div class="d-flex flex-column">' +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return '<span class="user-code">' +currencySymbol + full['amount'] + '</span>';
          }
        },
        {
          // Payment Gateway
