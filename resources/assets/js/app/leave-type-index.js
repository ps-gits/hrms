...
$(function () {
...

        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              `<button class="btn btn-sm btn-icon edit-record" data-id="${full['id']}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddOrUpdateLeaveType"><i class="bx bx-pencil"></i></button>` +
  ...
  $(document).on('click', '.edit-record', function () {
    ...
    $.get(`${baseUrl}leaveTypes\/getLeaveTypeAjax\/${id}`, function (data) {
      ...
      // Set the isProofRequired toggle
      var isProofRequired = data.isProofRequired == 1;
